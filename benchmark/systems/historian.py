...
class Historian:
    ...
    def record(self, hour: int, batch_id: str, signals: dict[str, float], asset_id: str | None = None) -> None:
        self.points.append({"hour": hour, "batch_id": batch_id, "asset_id": asset_id, **signals})
